#!/bin/bash
#
VERSION="2019-09-07 00:36"
THIS_FILE="scripts_from_github.sh"
#
...
## Code Change History
##
## 2019-09-02 *f_wget get files in project apt-pkg-upgrade.
##
## 2018-07-18 *f_wget get new files in project cliappmenu only for
##             repositories Testing and Development.
##
